...
<div class="content">
	<div  class="mainblock innerblock">
		...
		<div class="newmessageform centeredblock">
			<form name="addnewmessageform" id="addnewmessageform" action="/forum/postnewmessageform" class="mainform"   method="POST">
						
				<p>
					<label for="messageeditor" class="formlabel">Новое сообщение с цитированием:<br />
					<textarea  id="messageeditor" name="messageeditor" rows="20" cols="110" class="maintextarea"><? echo $messagetext; ?></textarea>		
				...
				<input type="hidden" name="topicid" id="topicid"  value="<?php echo $tid;  ?>">
				<input type="hidden" name="messageid" id="messageid" value="<?php echo $mid;  ?>">
				<input type="hidden" name="snumber" value="<?php echo md5(md5(session_id()));  ?>">
				<input type="hidden" name="skey" value="<?php echo $skey; ?>">
				<br>
				<p><input type="submit" name="postnewmessage" class="mainbutton" value="Сохранить" /></p>
			...
			<form id="uploadattachform" enctype="multipart/form-data"  method="POST">
				...
				<input type="hidden" name="messageid" id="topicid"  value="<?php echo $mid;  ?>" size="10" />
				<input type="hidden" name="snumber" value="<?php echo md5(md5(session_id()));  ?>">
